...
def build_transparency_report_text(text_input: str = "", findings=None) -> str:
    ...
    lines = [
        ...
        "- The deterministic engine checks package text against a fixed IND-readiness checklist.",
        ...
        "- Genotoxicity",
        "- PK / ADME support",
        "- Bioanalytical readiness",
        "- CMC process description",
...
def build_transparency_report_pdf(text_input: str = "", findings=None) -> bytes:
    ...
    c.setTitle("IND-Readiness-Checker Transparency & Oversight Report")
    c.setFont("Helvetica-Bold", 14)
    c.drawString(left, y, "IND-Readiness-Checker Transparency & Oversight Report")
    y -= 10 * mm
...
if st.session_state.ind_done:
    ...
    st.download_button(
        ...
        file_name="ind_readiness_checker_transparency_report.pdf",
