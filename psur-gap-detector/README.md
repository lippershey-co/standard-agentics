...
Audit a PSUR draft summary for possible missing or incomplete section coverage before formal regulatory review.

## What it does

PSUR-Gap-Detector accepts pasted PSUR or pharmacovigilance-summary text and runs a deterministic completeness engine to surface possible first-pass gaps.
...
It currently checks a starter set of PSUR areas:
1. Reporting interval
2. Worldwide authorization status
3. Actions taken for safety reasons
4. Reference safety information changes
5. Estimated exposure
6. Individual case safety data
7. Signal evaluation
...
- does not determine regulatory adequacy or submission acceptability
...
- PSUR / pharmacovigilance text only for AI summary
- No PDF or DOCX support for PSUR inputs in the public demo
...
- It does not determine regulatory adequacy
- It does not determine submission acceptability
- It does not make final legal, medical, or regulatory judgments
- It is not intended for production use

## Demo flow

1. Paste a PSUR draft or PV summary
2. Run the deterministic gap check
3. Review findings, status, and the PSUR completeness table
